...
# SubBio-Mon monitoring plan 

## Row 1 {data-height="100," data-padding="15"}

### Monitoring plant 

The aim of the eDNA monitoring plan is to sample at least 2 caves. Each caves should be sample for at least 3 different habitats (For instance, stream, syphon and gour) and for 2 hydrologic conditions for a total of 12 samples per country. 

## Row 1 {data-height="500," data-padding="15"}

### Plan 

<img src="Media/Plan.png" alt="Description of image" width="250" height="180"/>

### Note 

For each cave, different aspects are needed:

- Filter at least 5 liters of water per site (some areas show very low amounts of DNA even at 10 liters of water, so this amount is somewhat necessary).

- A topographic map of the cave with the sampling site indicated.

- The location of the cave.

- If possible, physicochemical measurements:
...
## Row 4 {data-height="400," data-padding="15"}

### Sending Filter 

<img src="Media/FILTRE2.jpg" alt="Description of image" width="250" height="180"/>

### Note

- After filtering, it is important to keep the SAME buffer syringe that you used for the sampling and put it together with the filter. Since i need to extract the buffer for extraction, this allow me to reuse the buffer syringe and avoid the use of an extra sterile syringe. 

- After filtering, try to preserve the filter in a cold place and in dark. This is not mandatory but is preferable for transport if possible. 

# eDNA extraction {data-navmenu="Laboratory"}
...
# PCR cleanup {data-navmenu="Laboratory"}
...
# Sequencing {data-navmenu="Laboratory"}
